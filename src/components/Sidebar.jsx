...
export default function Sidebar() {
  return (
    <div className="w-60 bg-neutral-900 h-full text-white flex flex-col gap-6 p-6">
      <h2 className="text-5xl font-bold font-irishgrover">Rizz</h2>
      <NavLink to="/home" className="flex gap-2 items-center"><Flame size={18}/> Trending</NavLink>
